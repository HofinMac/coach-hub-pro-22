...
export const planTemplates: PlanTemplate[] = [
  {
    ...
    category: 'Začátečník',
    exercises: [
      { exerciseId: 'e21', exerciseName: 'Goblet Squat', sets: 3, reps: '10', rpe: 6, rest: 90 },
      { exerciseId: 'e35', exerciseName: 'Push-Up', sets: 3, reps: '10', rpe: 6, rest: 60 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: 'e11', exerciseName: 'Incline DB Press', sets: 4, reps: '10', rpe: 7, rest: 90 },
      { exerciseId: 'e33', exerciseName: 'DB Shoulder Press', sets: 3, reps: '10', rpe: 7, rest: 90 },
      { exerciseId: 'e34', exerciseName: 'Lateral Raise', sets: 3, reps: '15', rpe: 7, rest: 60 },
      { exerciseId: 'e36', exerciseName: 'Cable Fly', sets: 3, reps: '12', rpe: 7, rest: 60 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: 'e39', exerciseName: 'Lat Pulldown', sets: 4, reps: '10', rpe: 7, rest: 90 },
      { exerciseId: 'e16', exerciseName: 'Cable Row', sets: 3, reps: '12', rpe: 7, rest: 90 },
      { exerciseId: 'e15', exerciseName: 'Face Pulls', sets: 3, reps: '15', rpe: 6, rest: 60 },
      { exerciseId: 'e43', exerciseName: 'Barbell Curl', sets: 3, reps: '10', rpe: 7, rest: 60 },
  ...
  },
  {
    id: 'tpl4',
    name: 'Leg Day – Síla',
    description: 'Silový trénink nohou se zaměřením na squat a deadlift.',
    category: 'Split',
    exercises: [
      { exerciseId: 'e1', exerciseName: 'Back Squat', sets: 5, reps: '5', rpe: 8, rest: 180 },
      { exerciseId: 'e5', exerciseName: 'Romanian Deadlift', sets: 4, reps: '8', rpe: 7, rest: 120 },
      { exerciseId: 'e3', exerciseName: 'Bulgarian Split Squat', sets: 3, reps: '10', rpe: 7, rest: 120 },
      { exerciseId: 'e30', exerciseName: 'Leg Curl (Lying)', sets: 3, reps: '12', rpe: 7, rest: 60 },
      { exerciseId: 'e23', exerciseName: 'Leg Extension', sets: 3, reps: '12', rpe: 7, rest: 60 },
    ],
  },
  {
    id: 'tpl5',
    name: 'Upper Body – Hypertrofie',
    description: 'Objem pro horní polovinu těla. 10-15 opakování.',
    category: 'Hypertrofie',
    exercises: [
      { exerciseId: 'e11', exerciseName: 'Incline DB Press', sets: 4, reps: '12', rpe: 7, rest: 90 },
      { exerciseId: 'e40', exerciseName: 'T-Bar Row', sets: 4, reps: '12', rpe: 7, rest: 90 },
  ...
  },
  {
    id: 'tpl6',
    name: 'Glute Focus',
    description: 'Trénink zaměřený na gluteální svaly. Skvělé pro bikini prep.',
  ...
  },
  {
    ...
    exercises: [
      { exerciseId: 'e62', exerciseName: 'Banded Pull-Apart', sets: 3, reps: '20', rpe: 4, rest: 45 },
  ...
  },
  {
    ...
    category: 'Kondice',
    exercises: [
      { exerciseId: 'e19', exerciseName: 'Assault Bike Intervals', sets: 6, reps: '30s', rpe: 9, rest: 30 },
  ...
  {
    id: 'tpl9',
    name: 'Mobilita & Zotavení',
    description: 'Aktivní regenerace a práce na mobilitě. Ideální na off day.',
    category: 'Mobilita',
    exercises: [
  ...
  },
  {
    ...
    category: 'Síla',
    exercises: [
      { exerciseId: 'e1', exerciseName: 'Back Squat', sets: 5, reps: '3', rpe: 9, rest: 240 },
      { exerciseId: 'e9', exerciseName: 'Bench Press', sets: 5, reps: '3', rpe: 9, rest: 180 },
      { exerciseId: 'e6', exerciseName: 'Conventional Deadlift', sets: 3, reps: '2', rpe: 9.5, rest: 300 },
